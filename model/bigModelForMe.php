...
header("Content-Type: text/html; charset=utf-8");
			try
			{
				$db = new PDO('mysql:host=localhost;dbname=u207806544_generatedevis','u207806544_franck3','Bd@.2023');
				//$db = new PDO('mysql:host=localhost;dbname=btobapp','root',''); //GC009 client ayant plusieurs adresses livraison
